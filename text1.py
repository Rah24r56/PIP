...
def hero():
    ...
    while(y):
        clear()
        system(banner)
        print("Contact me on telegram @ra_hu7")
...
if(expirydate>today):
    ...
    if (now>Third and now<Thirdend):
        ...
        print("26th Jan 2022, 11:00 AM- 11:30 AM")
        #print("26th Jan 2022, 02:00 PM- 02:30 PM")
        #print("26th Jan 2022, 04:00 PM- 04:30 PM")
        #print("26th Jan 2022, 08:00 PM- 08:30 PM")
    ...
    while(True):
        print("My banking name is RAHUL")
        print("If you send to any other name , then IT IS SCAMMM")
        print("--------*--------*----------*---------")
        print("send payment only to RAHUL ")
        print("payhere--- UPI : ")
        print("UPI1 : rahulmr@oksbi")
